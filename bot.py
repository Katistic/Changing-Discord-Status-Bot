...
"status": "text to animate (your status xd)",
"changeRate": 4, -- Number of seconds for each section of animation (minimum is 4 seconds)
"animType": 0 -- Status animation type, 0 is 1 word displayed at a time, 1 \
is each letter appears 1 at a time
